      ...
      <div className="container px-10 flex flex-col justify-center py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          <a
            ...
            href="#"
            className="flex justify-center space-x-5 lg:justify-start"
          >
            ...
            <p>
              <span className="text-4xl font-bold">Innfinity.</span> <br />
              Elevating Hospitality with Trusted Technology since 1992.
            </p>
          </a>
        </div>
        <div className="grid grid-cols-2 text-sm mx-auto y gap-y-8 lg:w-2/3 sm:grid-cols-4">
